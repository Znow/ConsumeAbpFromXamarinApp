...
public static class ConsumeAbpFromXamarinAppAPIEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE ConsumeAbpFromXamarinAppAPIModuleExtensionConfigurator CLASS (in the Domain.Shared project)
